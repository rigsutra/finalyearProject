# ---------------------------------------------
#  EfficientNet‑B4 Transfer Learning Script
# ---------------------------------------------
# Save as efficientnet_b4_train.py
...
for epoch in range(1,EPOCHS+1):
    ...
    if va>best_acc:
        best_acc=va; torch.save(model.state_dict(),'best_b4.pth'); es=0
    else:
        es+=1; 
...
plt.title('Confusion Matrix B4'); plt.show()
